        ...
        <div className="w-full py-5">
          ...
          {isOwner && (
            <div className="py-3 px-4 space-y-4">
              <Link to="/settings">
                <div className="w-full h-[42px] bg-blue-600 rounded-[5px] flex justify-center items-center cursor-pointer">
                  <span className="text-white">Edit Shop</span>
                </div>
              </Link>
              <div
                className="w-full h-[42px] bg-red-600 rounded-[5px] flex justify-center items-center cursor-pointer"
